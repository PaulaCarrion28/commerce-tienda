...
export default function LoginPage() {
  ...
  const validate = () => {
    const errs = {}
    if (!form.username.trim()) errs.username = 'Ingresa tu nombre de usuario'
    if (!form.pin.trim()) errs.pin = 'Ingresa tu PIN'
    else if (form.pin.length < 4) errs.pin = 'El PIN debe tener al menos 4 caracteres'
    return errs
  }
      ...
      <div className="w-full max-w-md relative z-10 animate-slide-up">
        ...
        <div className="glass-card p-8">
          ...
          <p className="text-center text-xs text-gray-600 mt-5">
            Puedes usar cualquier usuario y PIN para ingresar.
          </p>
        </div>
      </div>
    </div>
