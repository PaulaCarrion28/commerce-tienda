...
function StockIndicator({ stock }) {
  if (stock === 0) return <span className="badge bg-red-500/15 text-red-400 border border-red-500/20">Sin stock</span>
  if (stock <= 5) return <span className="badge bg-amber-500/15 text-amber-400 border border-amber-500/20">Stock bajo</span>
    ...
    <div className="glass-card-hover group animate-slide-up overflow-hidden">
      ...
      <div className="relative h-44 overflow-hidden rounded-t-2xl">
        ...
        <div className="absolute top-3 left-3">
          <span className={`badge border ${getCategoryStyle(product.categoria)}`}>
            {product.categoria}
          </span>
        </div>
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mt-3">
          <div>
            ...
            <p className="font-display font-bold text-xl text-white">
              ${Number(product.precio).toLocaleString('es-CO', { minimumFractionDigits: 0 })}
            </p>
          </div>
        ...
        <div className="flex gap-2 mt-4 pt-4 border-t border-white/5">
          <Link
            ...
            className="btn-edit flex-1 justify-center text-xs"
          >
